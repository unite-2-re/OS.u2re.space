    ...
    return (
        <ui-modal class="adl-modal" data-hidden data-alpha="1" data-scheme="solid">
                ...
                <For each={form}>
                    {(input) => (
                        <label>
                            ...
                            >
                                {(() => {
                                    const Field = fieldTypes?.get(input?.type);
                                    return Field ? <Field input={input} /> : null;
                                })()}
                            </div>
                        </label>
                    )}
            ...
            <div data-alpha="0" data-highlight="0" class="adl-buttons">
                ...
                <button onClick={deleteA} class="adl-delete" data-scheme="inverse" data-chroma="0.05">
                    Delete
                </button>
                <button onClick={confirm} class="adl-confirm" data-scheme="inverse" data-chroma="0.05">
                    Confirm
                </button>
            </div>
        </ui-modal>
