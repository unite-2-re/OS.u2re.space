...
export const Settings = () => {
    ...
    return html`<div data-alpha="0" data-scheme="solid" class="ui-content" id="settings" ref=${$content} data-tab=${currentTab} ref=${observe(["data-tab", setTab])}>
        ...
        <ui-scrollbox data-alpha="0" data-highlight="0" data-chroma="0" class="adl-tab-box" data-alpha="1">
            <div class="adl-tabs">
                <${For} each=${() => tabs}>${(tab) => {
        ...
        <ui-scrollbox data-alpha="0" data-highlight="0" data-chroma="0" class="adl-content-box">
            <${Content} tab=${()=>cTab}>
                <${For} each=${() => forms}>${(form) => {
