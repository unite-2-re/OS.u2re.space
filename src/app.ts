...
export const initialize = async (root)=>{
    ...
    //
    const loadingModules = Promise.allSettled([ // @ts-ignore
        import(/* @vite-ignore */ "/externals/modules/dom.js"), // @ts-ignore
        import(/* @vite-ignore */ "/externals/modules/theme.js"), // @ts-ignore
        import(/* @vite-ignore */ "/externals/modules/ui.js"),
    ]);
